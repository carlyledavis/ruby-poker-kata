module RSpec
  module Matchers
    module BuiltIn
      ...
      # the yield behavior of the object-under-spec.
      class YieldProbe
        ...
        def assert_used!
          ...
          raise "You must pass the argument yielded to your expect block on " \
                "to the method-under-spec as a block. It acts as a probe that " \
                "allows the matcher to detect whether or not the method-under-spec " \
