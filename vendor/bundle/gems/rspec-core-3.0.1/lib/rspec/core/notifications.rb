...
module RSpec::Core
  ...
  module Notifications
    ...
    # a spec suite. It is used by formatters to provide information at the end
    # of the spec run.
    #
    ...
    # a spec suite when profiling is enabled. It is used by formatters to provide
    # information at the end of the spec run for profiling information.
    #
    # @attr duration [Float] the time taken (in seconds) to run the suite
    # @attr examples [Array(RSpec::Core::Example)] the examples run
