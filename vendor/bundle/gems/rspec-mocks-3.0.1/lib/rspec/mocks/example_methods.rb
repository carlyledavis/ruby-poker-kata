...
module RSpec
  module Mocks
    ...
    # Mix this in to your spec context (such as a spec framework base class)
    # to use rspec-mocks with your spec framework. If you're using rspec-core,
    ...
    module ExampleMethods
      ...
      #
      # Constructs a spec double against a specific class. If the given class
      ...
      #
      # Constructs a spec double against a specific object. Only the methods
      ...
      # undefined for the duration of the spec.
      #
      ...
      # course of the spec. The method must have previously been stubbed in
      ...
      #
      # stubs/mocks a chain of messages on an object or spec double.
      #
      # ## Warning:
      #
