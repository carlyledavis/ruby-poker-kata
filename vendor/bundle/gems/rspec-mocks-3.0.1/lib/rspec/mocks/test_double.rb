module RSpec
  module Mocks
    # Implements the methods needed for a pure spec double.  RSpec::Mocks::Double
    # includes this module, and it is provided for cases where you want a
    # pure spec double without subclassing RSpec::Mocks::Double.
    module TestDouble
      # Creates a new spec double with a `name` (that will be used in error
      # messages only)
      ...
      # Override for default freeze implementation to prevent freezing of spec
      # doubles.
      def freeze
        RSpec.warn_with("WARNING: you attempted to freeze a spec double. This is explicitly a no-op as freezing doubles can lead to undesired behaviour when resetting tests.")
      end
    ...
    # A generic spec double object. `double`, `instance_double` and friends
